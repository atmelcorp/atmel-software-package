#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c"
...
#line 75 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c"
...
#line 76 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c"
...
#line 77 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c"
...
#line 79 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c"
...
void tc_configure(Tc * pTc, uint32_t channel, uint32_t mode)
{
	...
	((channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))) ? (void)0 : ( __aeabi_assert("channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c", 100), ( __iar_EmptyStepPoint())));
...
void tc_start(Tc * pTc, uint32_t channel)
{
	...
	((channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))) ? (void)0 : ( __aeabi_assert("channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c", 129), ( __iar_EmptyStepPoint())));
...
void tc_stop(Tc * pTc, uint32_t channel)
{
	...
	((channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))) ? (void)0 : ( __aeabi_assert("channel < (sizeof (pTc->TC_CHANNEL) / sizeof (pTc->TC_CHANNEL[0]))", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\tc.c", 149), ( __iar_EmptyStepPoint())));
				  ...
				  uint32_t * tc_clks)
{
	...
	const uint32_t periph_clock = pmc_get_peripheral_max_clock((35));

#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c"
...
#line 37 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c"
...
#line 40 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c"
...
#line 43 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c"
...
#line 44 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c"
...
static void cp15_cycle_count_divider(uint8_t Divider)
{
	...
	(((Divider > 1 ? 0 : 1)) ? (void)0 : ( __aeabi_assert("(Divider > 1 ? 0 : 1)", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c", 70), ( __iar_EmptyStepPoint())));
...
static void cp15_select_event(PerfEventType EventType, uint8_t Counter)
{
	...
	(((Counter == 1) || (Counter == 2)) ? (void)0 : ( __aeabi_assert("(Counter == 1) || (Counter == 2)", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c", 163), ( __iar_EmptyStepPoint())));
...
uint32_t cp15_init_cycle_counter(void)
{
	...
	cp15_clear_PMCNT();
	cp15_enable_PMCNT();
	cp15_overflow_status(1, 3);
	cp15_cycle_count_divider(1);
	cp15_pmu_control(2, 1);
...
void cp15_init_perf_counter(PerfEventType Event, uint8_t Counter)
{
	...
	cp15_pmu_control(1, 1);
	cp15_select_event(Event, Counter);
	cp15_overflow_status(0, 3);

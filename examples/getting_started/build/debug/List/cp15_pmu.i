...
{
	uint32_t PMU_Value = 0;
	(((Divider > 1 ? 0 : 1)) ? (void)0 : ( __aeabi_assert("(Divider > 1 ? 0 : 1)", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c", 69), ( __iar_EmptyStepPoint())));
    asm("mrc     p15, 0, %0, c9, c12, 0":"=r"(PMU_Value));
	PMU_Value |= (Divider << 3);
    asm("mcr     p15, 0, %0, c9, c12, 0": :"r"(PMU_Value));
}
...
static void cp15_select_event(PerfEventType EventType, uint8_t Counter)
{
	...
	(((Counter == 1) || (Counter == 2)) ? (void)0 : ( __aeabi_assert("(Counter == 1) || (Counter == 2)", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15_pmu.c", 155), ( __iar_EmptyStepPoint())));

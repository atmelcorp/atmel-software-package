#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
...
#line 36 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/l2cc.h"
...
#line 59 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/l2cc.h"
...
#line 37 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
...
#line 38 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
...
#line 39 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
#line 1 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 7.2\\arm\\inc\\c\\assert.h"
...
#line 40 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c"
...
{
	pL2CC->L2CC_CR |= (0x1u << 0);
	{ printf("-I- " "L2 cache is enabled"); };
}
...
L2CC_ExclusiveCache(L2cc * pL2CC, uint8_t Enable)
{
	...
	if (Enable) {
		...
		Aux_Cfg |= (0x1u << 12);
		{ printf("-I- " "L2 Exclusive mode Enabled\n\r"); };
	} else {
		cp15_non_exclusive_cache();
		Aux_Cfg &= ~(0x1u << 12);
		{ printf("-I- " "L2 Exclusive mode Disabled\n\r"); };
	}
...
L2CC_ConfigLatRAM(L2cc * pL2CC, RAMLatencyControl * pLat)
{
	...
	pL2CC->L2CC_TRCR =
	    ((((0x7u << 0) & ((pLat->TagRAM . SetupLAT) << 0))) |
	     (((0x7u << 4) & ((pLat->TagRAM . ReadLAT) << 4))) | (((0x7u << 8) & ((pLat-> TagRAM . WriteLAT) << 8))));


	pL2CC->L2CC_DRCR =
	    ((((0x7u << 0) & ((pLat->DataRAM . SetupLAT) << 0))) |
	     (((0x7u << 4) & ((pLat->DataRAM . ReadLAT) << 4))) | (((0x7u << 8) & ((pLat-> DataRAM . WriteLAT) << 8))));
...
L2CC_Config(L2cc * pL2CC, L2CC_Control L2cc_Config)
{
	...
	if (L2cc_Config.OFFSET_Val > 31) {
		((0) ? (void)0 : ( __aeabi_assert("0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 136), ( __iar_EmptyStepPoint())));
	}
	if ((L2cc_Config.OFFSET_Val > 7) && (L2cc_Config.OFFSET_Val < 15)) {
		((0) ? (void)0 : ( __aeabi_assert("0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 139), ( __iar_EmptyStepPoint())));
	}
	if ((L2cc_Config.OFFSET_Val > 15) && (L2cc_Config.OFFSET_Val < 23)) {
		((0) ? (void)0 : ( __aeabi_assert("0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 142), ( __iar_EmptyStepPoint())));
	}
	if ((L2cc_Config.OFFSET_Val > 23) && (L2cc_Config.OFFSET_Val < 31)) {
		((0) ? (void)0 : ( __aeabi_assert("0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 145), ( __iar_EmptyStepPoint())));
	}
	...
	AuxiliaryControl = ((L2cc_Config.HPSO_Val << 10) |
			    ...
			    ((((0x3u << 23) & ((L2cc_Config . FWA_Val) << 23)))) |
...
L2CC_EnableResetCounter(L2cc * pL2CC, uint8_t EventCounter)
{
	...
	(((EventCounter > 3) ? 0 : 1) ? (void)0 : ( __aeabi_assert("(EventCounter > 3) ? 0 : 1", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 228), ( __iar_EmptyStepPoint())));

	pL2CC->L2CC_ECR = ((0x1u << 0) | (EventCounter << 1));
		 ...
		 uint8_t IntGen)
{
	...
	(((EventCounter > 1) ? 0 : 1) ? (void)0 : ( __aeabi_assert("(EventCounter > 1) ? 0 : 1", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 249), ( __iar_EmptyStepPoint())));
...
L2CC_EventCounterValue(L2cc * pL2CC, uint8_t EventCounter)
{
	...
	(((EventCounter > 1) ? 0 : 1) ? (void)0 : ( __aeabi_assert("(EventCounter > 1) ? 0 : 1", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\l2cc.c", 268), ( __iar_EmptyStepPoint())));
...
{
	return ((pL2CC->L2CC_DCR & (0x1u << 2)) >> 2);
}
...
{
	while ((pL2CC->L2CC_CSR) & (0x1u << 0)) ;
	pL2CC->L2CC_CSR = (0x1u << 0);
	while ((pL2CC->L2CC_CSR) & (0x1u << 0)) ;
}
...
L2CC_InvalidatePAL(L2cc * pL2CC, uint32_t P_Address)
{
	...
	Tag = (P_Address >> (5 + 9));
	Index = (P_Address >> 5) & ((1 << 9) - 1);

	pL2CC->L2CC_IPALR =
	    ((((0x3ffffu << 14) & ((Tag) << 14))) | (((0x1ffu << 5) & ((Index) << 5))) | (0x1u << 0));

	while ((pL2CC->L2CC_IPALR) & (0x1u << 0)) ;
}
...
L2CC_CleanIx(L2cc * pL2CC, uint32_t P_Address)
{
	...
	while ((pL2CC->L2CC_CIPALR) & (0x1u << 0)) ;
}
...
L2CC_CleanIndex(L2cc * pL2CC, uint32_t P_Address, uint8_t Way)
{
	...
	pL2CC->L2CC_CIR =
	    ((((0x1ffu << 5) & ((Index) << 5))) | (((0x7u << 28) & ((Way) << 28))) | (0x1u << 0));

	while ((pL2CC->L2CC_CIR) & (0x1u << 0)) ;
}
...
L2CC_CleanInvalidateIndex(L2cc * pL2CC, uint32_t P_Address, uint8_t Way)
{
	...
	pL2CC->L2CC_CIIR =
	    ((((0x1ffu << 5) & ((Index) << 5))) | (((0x7u << 28) & ((Index) << 28))) | (0x1u << 0));

	while ((pL2CC->L2CC_CIIR) & (0x1u << 0)) ;
}
...
{
	cp15_cache_clean(0);	
	L2CC_CleanWay(((L2cc *)0x00A00000U), 0xFF);	
	L2CC_CacheSync(((L2cc *)0x00A00000U));	
}

static void
L2CC_Invalidate(void)
{
	L2CC_InvalidateWay(((L2cc *)0x00A00000U), 0xFF);	
	L2CC_CacheSync(((L2cc *)0x00A00000U));	
...
{
	cp15_cache_clean(0);	
	L2CC_CleanInvalidateWay(((L2cc *)0x00A00000U), 0xFF);	
	L2CC_CacheSync(((L2cc *)0x00A00000U));	
	cp15_cache_invalidate(0);	
}
...
Enable_L2CC(void)
{
	...
	L2Config.STBYEN_Val = 1;
	L2Config.DCKGATEN_Val = 1;

	L2CC_EventConfig(((L2cc *)0x00A00000U), 0, (0x2u << 2),
			 (0x0u << 0));
	L2CC_EventConfig(((L2cc *)0x00A00000U), 1, (0x4u << 2),
			 (0x0u << 0));
	L2CC_EnableResetCounter(((L2cc *)0x00A00000U), 3);

	L2CC_Config(((L2cc *)0x00A00000U), L2Config);

	 
	L2CC_InstPrefetchEnable(((L2cc *)0x00A00000U));
	L2CC_DataPrefetchEnable(((L2cc *)0x00A00000U));

	 
	L2CC_InvalidateWay(((L2cc *)0x00A00000U), 0xFF);
	 
	L2CC_DisableIT(((L2cc *)0x00A00000U), 0x1FF);
	 
	L2CC_ITClear(((L2cc *)0x00A00000U), 0);

	L2CC_ExclusiveCache(((L2cc *)0x00A00000U), 1);
	L2CC_Enable(((L2cc *)0x00A00000U));
}

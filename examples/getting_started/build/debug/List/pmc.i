#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
#line 71 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
#line 72 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
#line 73 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
#line 74 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
#line 76 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c"
...
{
	uint32_t mckr_value = ((Pmc *)0xF0014000U)->PMC_MCKR;
	uint32_t pllar_value = ((0x7fu << 18) & ((Pmc *)0xF0014000U)->CKGR_PLLAR) >> 18;
	uint32_t mdiv = ((((0x3u << 8) & ((mckr_value) << 8))) < 3) ?
		(1u << (((0x3u << 8) & ((mckr_value) << 8)))) : 3;

	board_master_clock = 12000000 / mdiv / (mckr_value & (0x1u << 12) ? 2:1)
		* (pllar_value + 1);
}
...
{
	((id < (79)) ? (void)0 : ( __aeabi_assert("id < ID_PERIPH_COUNT", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c", 107), ( __iar_EmptyStepPoint())));
...
uint32_t pmc_get_peripheral_clock(uint32_t id)
{
	((id < (79)) ? (void)0 : ( __aeabi_assert("id < ID_PERIPH_COUNT", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pmc.c", 118), ( __iar_EmptyStepPoint())));
	((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & ((id) << 0)));
	return (((Pmc *)0xF0014000U)->PMC_PCR & (0x3u << 16)) >> 16;
}
...
uint32_t pmc_set_peripheral_divider(uint32_t id, enum _dev_div div)
{
	...
	if (clock > max_clock)
		...
		((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & ((id) << 0))) | (0x1u << 12) | ( div << 16) | (0x1u << 28);
	return clock;
}
...
extern uint32_t pmc_set_peripheral_max_clock(uint32_t id)
{
	...
	((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & ((id) << 0))) | (0x1u << 12);
	maxClock = pmc_get_peripheral_max_clock(id);
	for (i = 0; i < 4; i++) {
		if (board_master_clock / (1 << i) <= maxClock)
			break;
	}
	((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & ((id) << 0))) | (0x1u << 12) | (i << 16) | (0x1u << 28);
	return maxClock;
}
...
void pmc_enable_peripheral(uint32_t id)
{
	...
	uint32_t pcr_value;
	((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & ((id) << 0))); 
	pcr_value = ((Pmc *)0xF0014000U)->PMC_PCR;          
	if ((pcr_value & (0x1u << 28)) != 0x0)
	{
		{ };
	}
	else
		((Pmc *)0xF0014000U)->PMC_PCR = (pcr_value & ~(0x7fu << 0)) | (0x1u << 12) | (((0x7fu << 0) & ((id) << 0))) | (0x1u << 28);
}
...
{
	if (id < 32) {
		if ((((Pmc *)0xF0014000U)->PMC_PCSR0 & ((uint32_t) 1 << id)) !=
		    ((uint32_t) 1 << id)) {
			{ };


		} else {
			((Pmc *)0xF0014000U)->PMC_PCDR0 = 1 << id;
		}
	} else {
		if ((((Pmc *)0xF0014000U)->PMC_PCSR1 & ((uint32_t) 1 << (id - 32))) !=
		    ((uint32_t) 1 << (id - 32))) {
			{ };


		} else {
			((Pmc *)0xF0014000U)->PMC_PCDR1 = 1 << (id - 32);
		}
	}
}
...
void pmc_enable_all_peripherals(void)
{
	((Pmc *)0xF0014000U)->PMC_PCER0 = 0xFFFFFFFF;
	((Pmc *)0xF0014000U)->PMC_PCER1 = 0xFFFFFFFF;
	{ };
}
...
{
	{ };
	((Pmc *)0xF0014000U)->PMC_PCDR0 = 0xFFFFFFFF;
	((Pmc *)0xF0014000U)->PMC_PCDR1 = 0xFFFFFFFF;
}
...
{
	if (id < 32) {
		return (((Pmc *)0xF0014000U)->PMC_PCSR0 & (1 << id));
	} else {
		return (((Pmc *)0xF0014000U)->PMC_PCSR1 & (1 << (id - 32)));
	}
}
...
void pmc_select_external_osc(void)
{
	...
	((Pmc *)0xF0014000U)->CKGR_MOR |= (0x1u << 0) | (0x37u << 16);
	 
	while (!(((Pmc *)0xF0014000U)->CKGR_MCFR & (0x1u << 16))) ;
	 
	((Pmc *)0xF0014000U)->CKGR_MOR |= (0x1u << 24) | (0x37u << 16);
	 
	while (!(((Pmc *)0xF0014000U)->PMC_SR & (0x1u << 16))) ;
...
void pmc_switch_mck_to_pll(void)
{
	...
	((Pmc *)0xF0014000U)->PMC_MCKR =
	    (((Pmc *)0xF0014000U)->PMC_MCKR & ~(0x3u << 0)) | (0x2u << 0);
	while (!(((Pmc *)0xF0014000U)->PMC_SR & (0x1u << 3)));
	_pmc_compute_mck();
}
...
void pmc_switch_mck_to_main(void)
{
	...
	((Pmc *)0xF0014000U)->PMC_MCKR =
	    (((Pmc *)0xF0014000U)->PMC_MCKR & ~(0x3u << 0)) | (0x1u << 0);
	while (!(((Pmc *)0xF0014000U)->PMC_SR & (0x1u << 3)));
	_pmc_compute_mck();
}
...
extern uint32_t pmc_switch_mck_to_slck(void)
{
	...
	((Pmc *)0xF0014000U)->PMC_MCKR =
	    (((Pmc *)0xF0014000U)->PMC_MCKR & ~(0x3u << 0)) | (0x0u << 0);
	while (!(((Pmc *)0xF0014000U)->PMC_SR & (0x1u << 3)));
	_pmc_compute_mck();
	return ((Pmc *)0xF0014000U)->PMC_MCKR;
}
...
void pmc_set_mck_plla_div(uint32_t divider)
{
	if ((((Pmc *)0xF0014000U)->PMC_MCKR & (0x1u << 12)) == (0x1u << 12)) {
		if (divider == 0) {
			((Pmc *)0xF0014000U)->PMC_MCKR = (((Pmc *)0xF0014000U)->PMC_MCKR & ~(0x1u << 12));
			while (!(((Pmc *)0xF0014000U)->PMC_SR & (0x1u << 3))) ;
		}
	} else {
		if (divider == (0x1u << 12)) {
...
void pmc_set_plla(uint32_t pll, uint32_t cpcr)
{
	((Pmc *)0xF0014000U)->CKGR_PLLAR = pll;
	((Pmc *)0xF0014000U)->PMC_PLLICPR = cpcr;
...
void pmc_disable_plla(void)
{
	((Pmc *)0xF0014000U)->CKGR_PLLAR =
	    (((Pmc *)0xF0014000U)->CKGR_PLLAR & ~(0x7fu << 18)) | (((0x7fu << 18) & ((0) << 18)));
}

#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
#line 120 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
#line 69 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 7.2\\arm\\inc\\c\\intrinsics.h"
...
#line 123 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
#line 126 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
#line 127 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
#line 129 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c"
...
void cp15_enable_icache(void)
{
	...
	if ((control & (1 << 12)) == 0) {
		...
		{ printf("-I- " "I cache enabled.\n\r"); };
	} else {

		{ printf("-I- " "I cache is already enabled.\n\r"); };
	}
}
...
void cp15_disable_icache(void)
{
	...
	if ((control & (1 << 12)) != 0) {
		...
		control &= ~(1ul << 12);
		cp15_write_control(control);
		{ printf("-I- " "I cache disabled.\n\r"); };
	} else {

		{ printf("-I- " "I cache is already disabled.\n\r"); };
	}
}
...
void cp15_enable_mmu(void)
{
	...
	if ((control & (1 << 0)) == 0) {
		...
		control |= (1 << 0);
		cp15_write_control(control);
		{ printf("-I- " "MMU enabled.\n\r"); };
	} else {

		{ printf("-I- " "MMU is already enabled.\n\r"); };
	}
}
...
void cp15_disable_mmu(void)
{
	...
	if ((control & (1 << 0)) != 0) {
		...
		control &= ~(1ul << 2);
		cp15_write_control(control);
		{ printf("-I- " "MMU disabled.\n\r"); };
	} else {

		{ printf("-I- " "MMU is already disabled.\n\r"); };
	}
}
...
void cp15_enable_dcache(void)
{
	...
	if (!cp15_is_mmu_enabled()) {
		{ printf("-E- " "Do nothing: MMU not enabled\n\r"); };
	} else {
		...
		if ((control & (1 << 2)) == 0) {
			...
			control |= (1 << 2);
			cp15_write_control(control);
			{ printf("-I- " "D cache enabled.\n\r"); };
		} else {

			{ printf("-I- " "D cache is already enabled.\n\r"); };
		}
	}
}
...
void cp15_disable_dcache(void)
{
	...
	if ((control & (1 << 2)) != 0) {
		...
		control &= ~(1ul << 2);
		cp15_write_control(control);
		{ printf("-I- " "D cache disabled.\n\r"); };
	} else {

		{ printf("-I- " "D cache is already disabled.\n\r"); };
	}
}
...
void cp15_cache_clean(uint8_t CacheType)
{
	((!CacheType) ? (void)0 : ( __aeabi_assert("!CacheType", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c", 300), ( __iar_EmptyStepPoint())));
	cp15_select_dcache();
...
void cp15_cache_flush(uint8_t CacheType)
{
	((!CacheType) ? (void)0 : ( __aeabi_assert("!CacheType", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\cp15.c", 330), ( __iar_EmptyStepPoint())));
	cp15_select_dcache();

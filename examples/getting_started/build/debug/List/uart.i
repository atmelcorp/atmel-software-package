#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\serial\\uart.c"
...
#line 35 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\serial\\uart.c"
...
#line 36 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\serial\\uart.c"
...
#line 37 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\serial\\uart.c"
...
#line 39 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\serial\\uart.c"
...
void uart_configure(Uart* pUart, uint32_t mode, uint32_t baudrate)
{
	...
	pUart->UART_CR = (0x1u << 2) | (0x1u << 3) | (0x1u << 5) | (0x1u << 7)
		| (0x1u << 8);
...
{
	if (enabled) pUart->UART_CR = (0x1u << 6);
	else pUart->UART_CR = (0x1u << 7);
}
...
{
	if (enabled)
		pUart->UART_CR = (0x1u << 4);
	else
		pUart->UART_CR = (0x1u << 5);
}

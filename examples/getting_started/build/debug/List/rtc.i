#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"
...
#line 91 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"


#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\time/rtc.h"
...
#line 46 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\time/rtc.h"



 

#line 59 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\time/rtc.h"
...
#line 99 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\time/rtc.h"
	 
#line 110 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\time/rtc.h"
...
#line 94 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"
...
#line 96 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"
...
#line 98 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"
...
#line 99 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c"
...
void rtc_set_hour_mode(Rtc * pRtc, uint32_t mode)
{
	(((mode & 0xFFFFFFFE) == 0) ? (void)0 : ( __aeabi_assert("(mode & 0xFFFFFFFE) == 0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c", 133), ( __iar_EmptyStepPoint())));
	pRtc->RTC_MR = mode;
}
...
void rtc_enable_it(Rtc * pRtc, uint32_t sources)
{
	(((sources & (uint32_t) (~0x1F)) == 0) ? (void)0 : ( __aeabi_assert("(sources & (uint32_t) (~0x1F)) == 0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c", 160), ( __iar_EmptyStepPoint())));
	{ };
...
void rtc_disable_it(Rtc * pRtc, uint32_t sources)
{
	(((sources & (uint32_t) (~0x1F)) == 0) ? (void)0 : ( __aeabi_assert("(sources & (uint32_t) (~0x1F)) == 0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\time\\rtc.c", 173), ( __iar_EmptyStepPoint())));
	{ };
...
extern int rtc_set_time(Rtc * pRtc, struct _time *pTime)
{
	...
	pRtc->RTC_CR |= (0x1u << 0);
	while ((pRtc->RTC_SR & (0x1u << 0)) != (0x1u << 0)) ;
	pRtc->RTC_SCCR = (0x1u << 0);
	pRtc->RTC_TIMR = ltime;
	pRtc->RTC_CR &= (uint32_t) (~(0x1u << 0));
	pRtc->RTC_SCCR |= (0x1u << 2);
	return (int) (pRtc->RTC_VER & (0x1u << 0));
}
...
extern int rtc_set_time_alarm(Rtc * pRtc, struct _time *pTime)
{
	...
	if (pTime->hour) {
		alarm |= (0x1u << 23) | ((pTime->hour / 10) << 20) | ((pTime->hour % 10) << 16);
	}
	 
	if (pTime->min) {
		alarm |= (0x1u << 15) | ((pTime->min / 10) << 12) | ((pTime->min % 10) << 8);
	}
	 
	if (pTime->sec) {
		alarm |= (0x1u << 7) | ((pTime->sec / 10) << 4) | (pTime->sec % 10);
	}
	pRtc->RTC_TIMALR = alarm;
	return (int) (pRtc->RTC_VER & (0x1u << 2));
}
...
extern int rtc_set_date(Rtc * pRtc, struct _date *pDate)
{
	...
	pRtc->RTC_SCCR = (0x1u << 0);
	pRtc->RTC_CALR = ldate;
	pRtc->RTC_CR &= (uint32_t) (~(0x1u << 1));
	pRtc->RTC_SCCR |= (0x1u << 2);	 
	return (int) (pRtc->RTC_VER & (0x1u << 1));
}
...
extern int rtc_set_date_alarm(Rtc * pRtc, struct _date *pDate)
{
	...
	if (pDate->month) {
		alarm |= (0x1u << 23) | ((pDate->month / 10) << 20) | ((pDate->month % 10) << 16);
	}
	if (pDate->day) {
		alarm |= (0x1u << 31) | ((pDate->day / 10) << 28) | ((pDate->day % 10) << 24);
	}
	 
	pRtc->RTC_CALALR = alarm;
	return (int) (pRtc->RTC_VER & (0x1u << 3));
}
...
void rtc_get_tamper_time(Rtc * pRtc, struct _time *pTime,  uint8_t reg_num)
{
	...
	if (pTime->hour) {
		...
		pTime->hour = (temp >> 4) * 10 + (temp & 0xfu);
		if ((ltime & (0x1u << 22)) == (0x1u << 22)) {
			pTime->hour += 12;
		}
	}
	...
	if (pTime->min) {
		...
		pTime->min = (temp >> 4) * 10 + (temp & 0xfu);
	}
	 
	if (pTime->sec) {
		temp = (ltime & (0x7fu << 0)) >> 0;
		pTime->sec = (temp >> 4) * 10 + (temp & 0xfu);
	}
}
...
void rtc_get_tamper_date(Rtc * pRtc, struct _date *pDate, uint8_t reg_num)
{
	...
	if (pDate->year) {
		...
		temp = (date & (0xffu << 8)) >> 8;
		pDate->year = (cent * 10 * 10) + (temp >> 4) * 10 + (temp & 0xfu);
	}
	 
	if (pDate->month) {
		temp = (date & (0x1fu << 16)) >> 16;
		pDate->month = (temp >> 4) * 10 + (temp & 0xfu);
	}
	 
	if (pDate->day) {
		temp = (date & (0x3fu << 24)) >> 24;
		pDate->day = (temp >> 4) * 10 + (temp & 0xfu);
	}
	 
	if (pDate->week) {
		pDate->week= ((date & (0x7u << 21)) >> 21);
	}
}
...
extern uint32_t rtc_get_tamper_event_counter(Rtc * pRtc)
{
	return (pRtc->RTC_TS[0].RTC_TSTR & (0xfu << 24)) >> 24;
}
...
extern uint8_t rtc_is_tamper_occur_in_backup_mode(Rtc * pRtc, uint8_t reg_num)
{
	if (pRtc->RTC_TS[reg_num].RTC_TSTR & (0x1u << 31)) {
		return 1;
	} else {
		return 0;
	}

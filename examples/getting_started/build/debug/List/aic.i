#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
#line 63 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
#line 64 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
#line 65 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/cp15_pmu.h"
...
#line 66 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
#line 68 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
#line 69 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\aic.c"
...
{
	((Aic *)0xFC020000U)->AIC_SSR = source;
	 
	((Aic *)0xFC020000U)->AIC_IDCR = (0x1u << 0);
	 
	((Aic *)0xFC020000U)->AIC_SMR = mode;
...
{
	uint8_t i;
	for (i=0; i<(sizeof(_id_h64_matrix)/sizeof(uint32_t)); i++) {
...
void aic_enable(uint32_t source)
{
	volatile unsigned int AicFuse = (*(volatile uint32_t*)0xF8030054U);

	if (AicFuse) {
		_aic_enable_it(((Aic *)0xFC020000U), source);
	}
	else {
		if (_is_h64_matrix(source)) {
			if (((Matrix *)0xF0018000U)->MATRIX_SPSELR[source / 32] & (1 << (source % 32)))
				_aic_enable_it(((Aic *)0xFC020000U), source);
			else
				_aic_enable_it(((Aic *)0xF803C000U), source);
		}
		else {
			if (((Matrix *)0xFC03C000U)->MATRIX_SPSELR[source / 32] & (1 << (source % 32)))
				_aic_enable_it(((Aic *)0xFC020000U), source);
			else
				_aic_enable_it(((Aic *)0xF803C000U), source);
		}
...
void aic_disable(uint32_t source)
{
	...
	if (AicFuse) {
		_aic_disable_it(((Aic *)0xFC020000U), source);
		return;
	}
	...
	if (_is_h64_matrix(source)) {
		if (((Matrix *)0xF0018000U)->MATRIX_SPSELR[source / 32] & (1 << (source % 32)))
			...
			_aic_disable_it(((Aic *)0xF803C000U), source);
	} else {
		if (((Matrix *)0xFC03C000U)->MATRIX_SPSELR[source / 32] & (1 << (source % 32)))
			_aic_disable_it(((Aic *)0xFC020000U), source);
		else
...
{
	Matrix *pMatrix;
	Aic *aic = ((Aic *)0xFC020000U);
	volatile unsigned int AicFuse = (*(volatile uint32_t*)0xF8030054U);

	if (0 == AicFuse) {
		pMatrix = (_is_h64_matrix(source)) ? ((Matrix *)0xF0018000U) : ((Matrix *)0xFC03C000U);

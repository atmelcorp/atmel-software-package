#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.c"
...
#line 48 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 120 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 121 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 153 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 169 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 170 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 379 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 388 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 419 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 444 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"

 
#line 452 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\target\\sama5d2\\sama5d27.h"
...
#line 13 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.c"
   
#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.h"
...
#line 11 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.h"
...
extern uint8_t TWID_DmaWrite(Twid * pTwid,
			     ...
			     uint32_t num,
			     Async * pAsync, uint8_t TWI_ID);
#line 12 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.h"
...
#line 14 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.h"
...
typedef struct _LocalTwi
{
    ...
    uint8_t*    pData;      
    Twid        twid;
} sTwiHandle , *psTwiHandle ;




extern void TestCallback(void);

extern uint8_t IsTwiReady (psTwiHandle ltwi);
extern uint8_t TwiHandleInit (psTwiHandle ltwi);
extern uint8_t TwidRdWr (psTwiHandle ltwi, enum TWI_CMD Cmd);
extern uint8_t TwidRdWrAsync (psTwiHandle ltwi, enum TWI_CMD Cmd);




#line 15 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\services\\service_twi.c"
...
static uint32_t Twi0Clk = 0;
static uint32_t Twi1Clk = 0;
static uint32_t Twi2Clk = 0;
static uint32_t Twi3Clk = 0;




uint8_t IsTwiReady (psTwiHandle ltwi)
{
...
uint8_t TwiHandleInit (psTwiHandle ltwi)
{
    ...
    switch (ltwi->IdTwi)
    {
        ...
        case (20):
          if (Twi1Clk!=ltwi->Twck) 
          {  
            
            ((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & (((20)) << 0))) | (0x1u << 12) | (0x1u << 28) | (0x2u << 16);  
            PIO_Configure(pinsTWI1, PIO_LISTSIZE(pinsTWI1));
            PMC_EnablePeripheral((20));
            Twi1Clk = ltwi->Twck;
         ...
         case (21):
          if (Twi2Clk!=ltwi->Twck) 
          {  
            
            ((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & (((21)) << 0))) | (0x1u << 12) | (0x1u << 28) | (0x2u << 16);  
            PIO_Configure(pinsTWI2, PIO_LISTSIZE(pinsTWI2));
            PMC_EnablePeripheral((21));
            Twi2Clk = ltwi->Twck;
            TWI_ConfigureMaster(TWI2, Twi2Clk, BOARD_MCK);
          }
          TWID_Initialize(&twid, TWI2);
          ltwi->Status = Status | TWI_STATUS_HANDLE;          
          break;         
 
          case (22):
          if (Twi3Clk!=ltwi->Twck) 
          {  
            
            ((Pmc *)0xF0014000U)->PMC_PCR = (((0x7fu << 0) & (((22)) << 0))) | (0x1u << 12) | (0x1u << 28) | (0x2u << 16);  
            PIO_Configure(pinsTWI3, PIO_LISTSIZE(pinsTWI3));
            PMC_EnablePeripheral((22));
            Twi3Clk = ltwi->Twck;
            TWI_ConfigureMaster(TWI3, Twi3Clk, BOARD_MCK);
          }
          TWID_Initialize(&twid, TWI3);
          ltwi->Status = Status | TWI_STATUS_HANDLE;          
          break;               
          
         default:
          ltwi->Status = TWI_STATUS_RESET;
          break;
    }
...
uint8_t TwidRdWr (psTwiHandle ltwi, enum TWI_CMD Cmd)
{
  if (Cmd == TWI_RD) 
...
uint8_t TwidRdWrAsync (psTwiHandle ltwi, enum TWI_CMD Cmd)
{
  Async async;
  uint8_t Status;
  ...
  {  
    ...
    Status = (uint8_t)TWID_Read(&ltwi->twid, ltwi->PeriphAddr, ltwi->RegMemAddr, ltwi->AddSize, 
                                (unsigned char*)ltwi->pData, ltwi->LenData, &async);
    while (!ASYNC_IsFinished(&async));
  }  
  else
  {  
    Status = (uint8_t)TWID_Write(&ltwi->twid, ltwi->PeriphAddr, ltwi->RegMemAddr, ltwi->AddSize, 
                                 (unsigned char*)ltwi->pData, ltwi->LenData, &async);
    while (!ASYNC_IsFinished(&async));
  }
  return Status;

#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 37 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 38 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 39 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 40 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 41 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
#line 43 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c"
...
static struct _interrupt_source int_sources[7];

 
static uint32_t num_sources = 0;

const uint8_t idt[4] = {(18), (68), (69), (70)};
...
void _pio_it_handler(uint8_t id)
{
	uint32_t status;
	uint32_t i;
	PioIo_group* pioiog = &((Pio *)0xFC038000U)->PIO_IO_GROUP[id];
	...
	if (status != 0) {
		...
		while (status != 0) {
			...
			((i < num_sources) ? (void)0 : ( __aeabi_assert("i < num_sources", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 104), ( __iar_EmptyStepPoint())));
...
{
	{ };
	((pin != 0) ? (void)0 : ( __aeabi_assert("pin != NULL", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 179), ( __iar_EmptyStepPoint())));
	((num_sources < 7) ? (void)0 : ( __aeabi_assert("num_sources < MAX_INTERRUPT_SOURCES", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 180), ( __iar_EmptyStepPoint())));
...
{
	{ };
	((pin != 0) ? (void)0 : ( __aeabi_assert("pin != NULL", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 201), ( __iar_EmptyStepPoint())));
	PioIo_group* pioiog = &pin->pio->PIO_IO_GROUP[pin->id];
	...
	((dwFound != 0) ? (void)0 : ( __aeabi_assert("dwFound != 0", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 214), ( __iar_EmptyStepPoint())));


	i = pioiog->PIO_ISR;
 	 
	pioiog->PIO_IER = pin->mask;	 
}
...
void pio_disable_it(const struct _pin *pin)
{
	((pin != 0) ? (void)0 : ( __aeabi_assert("pin != NULL", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4_it.c", 229), ( __iar_EmptyStepPoint())));
	{ };
	PioIo_group* pioiog = &pin->pio->PIO_IO_GROUP[pin->id];
	pioiog->PIO_IDR = pin->mask;
}

#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
...
#line 72 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
...
#line 74 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
...
#line 75 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
#line 1 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 7.2\\arm\\inc\\c\\stdint.h"
...
#line 76 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
...
#line 78 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"

#line 87 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c"
...
void spi_configure(Spi * spi, uint32_t dwConfiguration)
{
	...
	((spi_id != (79)) ? (void)0 : ( __aeabi_assert("spi_id != ID_PERIPH_COUNT", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\bus\\spi.c", 144), ( __iar_EmptyStepPoint())));
	 
	pmc_enable_peripheral(spi_id);
	uint32_t control_reg = (0x1u << 1);
...
void spi_write(Spi * spi, uint32_t dwNpcs, uint16_t wData)
{
	...
	while ((spi->SPI_SR & (0x1u << 9)) == 0) ;
	spi->SPI_TDR = wData | (((0x3u << 16) & (((~(1 << dwNpcs) & 0xF)) << 16)));
...
void spi_write_last(Spi * spi, uint32_t dwNpcs, uint16_t wData)
{
	...
	while ((spi->SPI_SR & (0x1u << 9)) == 0) ;
	spi->SPI_TDR = wData | (((0x3u << 16) & (((~(1 << dwNpcs) & 0xF)) << 16))) | (0x1u << 24);
	while ((spi->SPI_SR & (0x1u << 1)) == 0) ;
}

#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
#line 66 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
#line 67 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
#line 68 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
#line 70 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
#line 71 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c"
...
uint8_t pio_configure(const struct _pin *pin_list, uint32_t size)
{
	...
	while (size--)
	{
		((pin_list->id < 4) ? (void)0 : ( __aeabi_assert("pin_list->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 146), ( __iar_EmptyStepPoint())));
		cfg.uint32_value = 0;
		group = pin_list->id;
		pioiog = &pin_list->pio->PIO_IO_GROUP[group];

		if ( pin_list->attribute != (0x0u << 0)) {
			cfg.bitfield.puen = (pin_list->attribute & (0x1u << 0))? 1:0 ;
			cfg.bitfield.pden = (pin_list->attribute & (0x1u << 1))? 1:0 ;
			cfg.bitfield.ifen = (pin_list->attribute & (0x1u << 3))? 1:0 ;
			cfg.bitfield.ifscen = (pin_list->attribute & (0x1u << 4))? 1:0 ;
			cfg.bitfield.opd	= (pin_list->attribute & (0x1u << 2))? 1:0 ;
			cfg.bitfield.schmitt	= (pin_list->attribute & (0x1u << 5))? 1:0 ;
			cfg.bitfield.drvstr = pin_list->attribute & (0x3u << 10);
			cfg.bitfield.evtsel = pin_list->attribute & (0x7u << 12);
			cfg.bitfield.pcfs = (pin_list->attribute & (0x1u << 19))? 1:0 ;
			cfg.bitfield.icfs = (pin_list->attribute & (0x1u << 20))? 1:0 ;
		...
		case 1:
			cfg.bitfield.func = (0x1u << 0);
			break;
		case 2:
			cfg.bitfield.func = (0x2u << 0);
			break;
		case 3:
			cfg.bitfield.func = (0x3u << 0);
			break;
		case 4:
			cfg.bitfield.func = (0x4u << 0);
			break;
		case 5:
			cfg.bitfield.func = (0x5u << 0);
			break;
...
void pio_set(const struct _pin *pin)
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 225), ( __iar_EmptyStepPoint())));
...
void pio_clear(const struct _pin *pin)
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 239), ( __iar_EmptyStepPoint())));
	PioIo_group* pioiog = &pin->pio->PIO_IO_GROUP[pin->id];
...
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 257), ( __iar_EmptyStepPoint())));
    uint32_t reg ;
	PioIo_group* pioiog = &pin->pio->PIO_IO_GROUP[pin->id];

    if ((pin->type == 11) || (pin->type == 12)) {
	reg = pioiog->PIO_ODSR ;
    }
    else {
	reg = pioiog->PIO_PDSR ;
...
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 287), ( __iar_EmptyStepPoint())));
	PioIo_group* pioiog = &pin->pio->PIO_IO_GROUP[pin->id];
...
void pio_set_debounce_filter(const struct _pin *pin, uint32_t cuttoff)
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 305), ( __iar_EmptyStepPoint())));
	Pio *pio = pin->pio;
	if (cuttoff == 0) {
	   pio->S_PIO_SCDR = 0;
	}
...
void pio_enable_write_protect(const struct _pin *pin)
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 323), ( __iar_EmptyStepPoint())));
	Pio *pio = pin->pio;
...
void pio_disable_write_protect(const struct _pin *pin)
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 335), ( __iar_EmptyStepPoint())));
	Pio *pio = pin->pio;
...
{
	((pin->id < 4) ? (void)0 : ( __aeabi_assert("pin->id < PIO_GROUP_LENGTH", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\pio4.c", 347), ( __iar_EmptyStepPoint())));
	Pio *pio = pin->pio;
	return pio->PIO_WPSR;
}

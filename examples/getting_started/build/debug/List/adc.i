#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c"
...
#line 88 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c"
#line 1 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/adc.h"
...
#line 55 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/adc.h"
#line 1 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 7.2\\arm\\inc\\c\\stdint.h"
...
#line 56 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\examples\\getting_started/../../drivers\\core/adc.h"
...
#line 89 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c"
...
#line 90 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c"
...
#line 92 "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c"
...
adc_set_clock(Adc * pAdc, uint32_t dwClk, uint32_t dwMck)
{
	...
	dwMr = (((0xffu << 8) & ((dwPres) << 8)));
	if (dwMr == 0)
		return 0;

	dwMr |= (pAdc->ADC_MR & ~(0xffu << 8));
	pAdc->ADC_MR = dwMr;
...
{
	uint32_t dwTrgr = pAdc->ADC_TRGR & ~(0x7u << 0);
...
{
	((dwChannel <= 16) ? (void)0 : ( __aeabi_assert("dwChannel <= 16", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c", 339), ( __iar_EmptyStepPoint())));
...
adc_get_converted_data(Adc * pAdc, uint32_t dwChannel)
{
	...
	((dwChannel < 16) ? (void)0 : ( __aeabi_assert("dwChannel < 16", "C:\\Users\\dfronek\\Documents\\Project\\softpack\\drivers\\core\\adc.c", 417), ( __iar_EmptyStepPoint())));
...
adc_set_tracking_time(Adc * pAdc, uint32_t dwNs)
{
	...
	dwMr = (((0xfu << 24) & ((dwShtim) << 24)));
	dwMr |= pAdc->ADC_MR & ~(0xfu << 24);
	pAdc->ADC_MR = dwMr;
}
...
adc_set_trigger_period(Adc * pAdc, uint32_t dwPeriod)
{
	...
	dwTrgr = (((0xffffu << 16) & ((dwTrgper) << 16)));
	dwTrgr |= pAdc->ADC_TRGR & ~(0xffffu << 16);
...
{
	pADC->ADC_TSMR = (pADC->ADC_TSMR & ~(0x3u << 0)) | dwMode;
}
...
adc_set_ts_debounce(Adc * pADC, uint32_t dwTime)
{
	...
	dwTsmr = (((0xfu << 28) & ((dwPenbc) << 28)));
	if (dwTsmr == 0)
		return;
	dwTsmr |= pADC->ADC_TSMR & ~(0xfu << 28);
...
{
	uint32_t dwMr = pADC->ADC_TSMR & ~(0x3u << 4);
	uint32_t dwTSAV = dwAvg2Conv >> 4;
	uint32_t dwTSFREQ = (dwMr & (0xfu << 8)) >> 8;
	if (dwTSAV) {
		if (dwTSAV > dwTSFREQ) {
			dwMr &= ~(0xfu << 8);
			dwMr |= (((0xfu << 8) & ((dwTSAV) << 8)));
		}
	}
